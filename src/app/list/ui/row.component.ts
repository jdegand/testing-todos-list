  ...
  template: `
    <li
      ...
      <button [routerLink]="['/detail', ticket.id]" class="flex flex-col gap-2">
        ...
        <div data-testid="doneDiv"><span class="font-bold">Done:</span> {{ ticket.completed }}</div>
      </button>
      <div class="flex flex-col">
        <form
          ...
          <button data-testid="assignBtn" mat-flat-button color="primary" type="submit">Assign</button>
        </form>
        <button
          data-testid="doneBtn"
